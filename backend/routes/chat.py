    ...
    messages: list[dict] = [
        {
            "role": "system",
            "content": (
                "You are an elite, highly intelligent task management Specialist. "
                ...
                "2. When creating a heading, format it EXACTLY as 'Title Case:' on its own line (e.g., 'Action Plan:', 'Task Summary:'). NO asterisks around headings. Example: '\nAction Plan:\n'\n"
